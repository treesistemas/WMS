...
{
    public class ImpressaoPickingAcimaCapacidadeNegocios
    {
        //Instância a classe conexão
        Conexao conexao = new Conexao();

        //Pesquisa a pendencia
        public EnderecoCollection PesqPickingAcimaCapacidade(int regiao, int rua)
        {
            try
            {
                ...
                string select = "select (select conf_empresa from wms_configuracao ) as empresa, " +
                                "a.apa_endereco, p.prod_codigo, p.prod_descricao, p.prod_peso_variavel, s.sep_capacidade, " +
                                ...
                                "s.sep_validade, s.sep_peso, s.sep_lote, s.sep_tipo from wms_separacao s " +
                                ...
                                "where s.sep_capacidade < trunc(s.sep_estoque / p.prod_fator_pulmao) ";
