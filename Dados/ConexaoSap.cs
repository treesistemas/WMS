...
namespace Dados
{
    public class ConexaoSap
    {
        ...
        //Caminho de Produção
        string caminho = "Data Source=10.250.0.189;Initial Catalog=wms_sap; User ID=control-read; Password=Rd736$#@00kM; Min Pool Size=5;Max Pool Size=250; Connect Timeout=3600";
